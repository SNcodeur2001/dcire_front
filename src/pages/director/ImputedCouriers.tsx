...
export default function ImputedCouriers() {
  ...
  useEffect(() => {
    const fetchCourriers = async () => {
      try {
        // Fetch assigned courriers (imputés)
        const result = await api.courriers.getAssigned();
        if (result.error) {
    ...
    return (
      <DirectorLayout>
        <div className="h-full flex items-center justify-center">
          ...
          <p className="text-gray-600">Chargement des courriers imputés...</p>
        </div>
      </DirectorLayout>
    );
  }
        ...
        <div className="h-full flex items-center justify-center">
          <div className="text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">
              Aucun courrier à imputer
            </h3>
            <p className="text-gray-500">
              Tous les courriers ont été assignés aux départements appropriés.
            </p>
          </div>
        </div>
      </DirectorLayout>
          ...
          <div className="flex-1 min-h-0">
            <DirectorDataTable
              ...
              mails={courriers.map(c => ({
                ...
                receptionDate: c.receptionDate || 'N/A',
                status: 'imputé',
