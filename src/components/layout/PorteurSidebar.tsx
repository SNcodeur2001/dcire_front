...
const navItems: NavItem[] = [
  { to: '/porteur/tableau-de-bord', icon: '/icons/dashboard.svg', label: 'Tableau de bord' },
  { to: '/porteur/courriers-a-solder', icon: '/icons/mail.svg', label: 'Courriers à Solder' },
  { to: '/porteur/courriers-soldes', icon: '/icons/mail-settled.svg', label: 'Courriers soldés' },
  { to: '/porteur/courriers-archives', icon: '/icons/mail-assigned.svg', label: 'Courriers Archivés' },
];

export default function PorteurSidebar() {
